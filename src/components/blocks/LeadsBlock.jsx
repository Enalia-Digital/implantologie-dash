...
function RecordingButton() {
  return (
    ...
    >
      <svg width="10" height="10" viewBox="0 0 12 12" fill="none" stroke="#8A8A9E" strokeWidth="1.2">
        ...
        {data.leadsRecientes.map((lead, i) => {
          ...
          return (
            <div key={lead.nombre} style={{ borderTop: i === 0 ? 'none' : '1px solid var(--border-hairline)' }}>
              ...
              {expanded && (
                <div className="fade-in-up" style={{ padding: '0 20px 16px', background: 'rgba(255,255,255,0.02)' }}>
