...
function Metric({ label, value, accent }) {
  return (
    <div>
      ...
      <div style={{ fontSize: 22, fontWeight: 700, color: accent ? 'var(--accent)' : 'var(--text-primary)' }}>
        {value}
      </div>
    </div>
  );
...
export default function BillingBlock({ data, config }) {
  ...
  const total = mant + comValue + costeLlamadas;
